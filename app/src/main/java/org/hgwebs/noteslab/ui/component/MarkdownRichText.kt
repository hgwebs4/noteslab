...
import org.hgwebs.noteslab.ui.component.LocalContentWebViewClient.Companion.FILES_SCHEME
import org.hgwebs.noteslab.ui.component.LocalContentWebViewClient.Companion.NOTES_SCHEME
import org.hgwebs.noteslab.ui.ext.getCacheSharedDir
import java.io.*
...
private class LocalContentWebViewClient(
    ...
    companion object {
        const val ASSETS_SCHEME = "noteslab-assets"
        const val FILES_SCHEME = "noteslab-files"
        const val NOTES_SCHEME = "hgwebs1s"
        const val CORRUPT_FILES_SCHEME = "noteslab-corrupt-files"
    }
}
