package org.hgwebs.noteslab.data
...
import uniffi.noteslab.FfiAbbrNote
import uniffi.noteslab.FfiFolder
import uniffi.noteslab.FfiNote
import uniffi.noteslab.FfiResource
import uniffi.noteslab.FfiSearchNote
import uniffi.noteslab.FfiStatus
import uniffi.noteslab.FfiSyncInfo
import uniffi.noteslab.NoteslabAndroidData
import uniffi.noteslab.SyncConfig
import java.io.File
import javax.inject.Inject

class NoteslabNotesRepository @Inject constructor(
    databaseDir: String,
    ...
    private val data: NoteslabAndroidData =
        NoteslabAndroidData(databaseDir, resourceDir.absolutePath, logTxtFile.absolutePath)
